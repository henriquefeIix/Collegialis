...
final class SelectItemsIterator implements Iterator<SelectItem> {
    ...
    /**
     * Expose single SelectItems via an Iterator. This iterator will be reset/reused
     * for each individual SelectItem instance encountered.
     */
    ...
    /**
     * <p>
     * Base class to support iterating over Collections or Arrays that may or may
     * not contain <code>SelectItem</code> instances.
     * </p>
     */
    private static abstract class GenericObjectSelectItemIterator implements Iterator<SelectItem> {
         ...
         * <code>SelectItem</code> values based on <code>ValueExpressions</code> from
         * the owning {@link UISelectItems} instance.
         */
    ...
    /**
     * Handles arrays of <code>SelectItem</code>s, generic Objects, or combintations
     * of both.
     *
